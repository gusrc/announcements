  ...
  def announce announcement, options = {}
    ...
    if announcement != nil && cookies["announcement_" + announcement.id.to_s] != "hidden"
      if options[:format] == "bootstrap"
        ...
        result = content_tag(:div, close_content_tag + alert_content_tag + announcement.body, class: div_class)
      else
        ...
        result = content_tag(:div, announcement.body + close_content_tag, class: div_class)
      end
    end
